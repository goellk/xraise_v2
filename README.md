...
5. Now you can run inference:
```bash
python inference.py
```

6. Finally you can run an XAI method (Grad-CAM/LRP/CRAFT/CRP) on a trained model. Therefore, you also need to adjust the paths first. Open the gradcam|lrp|craft|crp.py file and change the parameters in the header, e.g. from craft.py:
