# TRAINING SCRIPT FOR VGG16 MODEL
...
train_img_dir = workspace_dir + TEST_IMG_DIR
train_annot_dir = workspace_dir + TEST_ANNOT_DIR
...
model = VGG16_BinaryClassifier(pretrained=True)
...
os.makedirs("vgg_models_512_v3", exist_ok=True)

# CSV logging
log_file = "log_vgg_512_v3.csv"
...
for epoch in range(EPOCHS):
    ...
    model_path = f"vgg_models_512_v3/vgg_training_512_epoch_{epoch + 1}.pth"
