...
os.makedirs("resnet50_models_512_v3", exist_ok=True)

# CSV logging
log_file = "log_resnet50_512_v3.csv"
...
for epoch in range(EPOCHS):
    ...
    model_path = f"resnet50_models_512_v3/resnet50_training_512_epoch_{epoch + 1}.pth"
